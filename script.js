document.addEventListener('DOMContentLoaded', () => {
    ...
    if (isLocal) {
        ...
        fetch('/.netlify/functions/views').then(r => r.json()).then(d => {
            document.getElementById('viewCount').textContent = d.views || 0;
            console.log('Global views:', d.views);
        }).catch(() => document.getElementById('viewCount').textContent = '—');
    }
